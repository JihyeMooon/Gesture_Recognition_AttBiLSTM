...
def parse_opts_offline(): 
    ...
    parser.add_argument(
        ...
        default=30,
        type=int,
        help='the number of frames after interpolation from the original video')
    parser.add_argument(
        '--image_size',
        default='224',
        type=int,
        help='112x112 is the size of image feeded into the model')
    parser.add_argument(
        '--torch_device',
        default='cuda:3',
        type=str,
    ...
    parser.add_argument(
        '--root_path',
        default='/home/jim19007/team_project/Updated_Gesture_Recognition_Normal_Updated_Increasing_Size/', 
        type=str,
        help='Root directory path of data')
    parser.add_argument(
        '--video_path',
        default='/home/jim19007/team_project/Gesture_Recognition_lite/Jester/20bn-jester-v1/',
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        'dataset for mean values of mean subtraction (activitynet)')
    parser.add_argument(
        '--no_mean_norm',
        action='store_true',
